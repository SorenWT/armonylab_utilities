...
echo "docker run -v ${1}:/data -v ${2}:/output -it sorenwt/openpose --display 0 --image-dir /data --write_images /output/openpose_output_img --write_json 
/output/openpose_output_json"

docker run -v ${1}:/data -v ${2}:/output -it sorenwt/openpose --display 0 --model_pose COCO --image_dir /data --write_images /output/openpose_output_img --write_json /output/openpose_output_json
